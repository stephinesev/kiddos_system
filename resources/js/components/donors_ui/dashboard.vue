...
<template>
	<navigation>
		...
		<div class="row">
            <div class="col-lg-12">
                <div class="shadow-lg rounded-t-xl">
                    <div class="bg-blue-500 rounded-t-xl py-2 px-4 text-white">
                        <div class="flex justify-start !space-x-2">
                            <span class="bg-gray-400 p-1 rounded-xl my-auto"></span>
                            <span class="m-0 text-sm">Saturday, 05 September, 2024</span>
                        </div>
                    </div>
                    <div class="p-4 bg-white">
                        <div class="card rounded-lg !border !border-teal-400 !border-l-8 mb-3">
                            <div class="card-body p-3">
                                <div class="flex justify-between">
                                    <div>
                                        ...
                                        <p class="text-base font-bold text-gray-800 my-1">Feeding Program</p>
