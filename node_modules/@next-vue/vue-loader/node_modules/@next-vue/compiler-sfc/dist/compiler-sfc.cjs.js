...
var compilerCore = require('@next-vue/compiler-core');
var url = require('url');
...
function parse(source, { sourceMap = true, filename = 'component.vue', sourceRoot = '', pad = false, compiler = require('@next-vue/compiler-dom') } = {}) {
...
function doCompileTemplate({ filename, inMap, source, compiler = require('@next-vue/compiler-dom'), compilerOptions = {}, transformAssetUrls }) {
    const errors = [];
    let nodeTransforms = [];
    ...
    newMapConsumer.eachMapping(m => {
        ...
        mergedMapGenerator.addMapping({
            ...
            original: {
                ...
                // use current column, since the oldMap produced by @next-vue/compiler-sfc
                // does not
                column: m.originalColumn
            },
            ...
            function rewriteSelector(selector, slotted) {
                ...
                selector.each(n => {
                    ...
                    if (n.type === 'combinator' &&
                        ...
                        console.warn(`[@next-vue/compiler-sfc] the >>> and /deep/ combinators have ` +
                    ...
                    if (n.type === 'pseudo') {
                        ...
                        if (n.value === '::v-deep') {
                            if (n.nodes.length) {
                                ...
                                // DEPRECATED usage
                                // .foo ::v-deep .bar -> .foo[xxxxxxx] .bar
                                console.warn(`[@next-vue/compiler-sfc] ::v-deep usage as a combinator has ` +
