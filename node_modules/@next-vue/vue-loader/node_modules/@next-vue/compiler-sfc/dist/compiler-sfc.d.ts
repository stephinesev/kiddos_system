import { CodegenResult } from '@next-vue/compiler-core';
import { CompilerError } from '@next-vue/compiler-core';
import { CompilerOptions } from '@next-vue/compiler-core';
import { generateCodeFrame } from '@next-vue/compiler-core';
import { LazyResult } from 'postcss';
import { ParserOptions } from '@next-vue/compiler-core';
import { RawSourceMap } from 'source-map';
import { Result } from 'postcss';
import { RootNode } from '@next-vue/compiler-core';
import { SourceLocation } from '@next-vue/compiler-core';
