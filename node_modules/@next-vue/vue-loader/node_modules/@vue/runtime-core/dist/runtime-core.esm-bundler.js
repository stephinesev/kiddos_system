import { pauseTracking, resumeTracking, isRef, toRaw, isReactive, unlock, lock, effect, stop, reactive, shallowReadonly, computed as computed$1 } from '@vue/reactivity';
...
function doWatch(source, cb, { lazy, deep, flush, onTrack, onTrigger } = EMPTY_OBJ) {
    ...
    if (lazy && cb) {
        ...
        if ((process.env.NODE_ENV !== 'production') && lazy && !cb) {
...
export { BaseTransition, Comment, Fragment, KeepAlive, PatchFlags, Portal, PublicShapeFlags as ShapeFlags, Suspense, Text, callWithAsyncErrorHandling, callWithErrorHandling, camelize$1 as camelize, capitalize$1 as capitalize, cloneVNode, computed, createBlock, createCommentVNode, createComponent, createHook, createRenderer, createSlots, createTextVNode, createVNode, getCurrentInstance, h, handleError, inject, injectHook, instanceWatch, mergeProps, nextTick, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onUnmounted, onUpdated, openBlock, popScopeId, provide, pushScopeId, recordEffect, registerRuntimeCompiler, renderList, renderSlot, resolveComponent, resolveDirective, resolveDynamicComponent, resolveTransitionHooks, setBlockTracking, setTransitionHooks, toHandlers, toString, useCSSModule, useTransitionState, version, warn, watch, withDirectives, withScopeId };
