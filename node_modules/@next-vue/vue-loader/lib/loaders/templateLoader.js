...
const { compileTemplate, compiler: rawComiler } = require('@next-vue/compiler-sfc')
...
module.exports = function (source) {
  ...
  const compiler = options.compiler || rawComiler
  ...
  return code.replace('from "vue"', 'from "next-vue"').replace('export default ', 'const render = ') + `\n
const staticRenderFns = render;
