...
function createCompilerError(code, loc, messages) {
    const msg = (process.env.NODE_ENV !== 'production') || !true ? (messages || errorMessages)[code] : code;
...
const TO_STRING = Symbol((process.env.NODE_ENV !== 'production') ? `toString` : ``);
...
// @next-vue/compiler-dom can export `compile` while re-exporting everything else.
...
const generateCodeFrame$1 = generateCodeFrame;

export { advancePositionWithClone, advancePositionWithMutation, assert, baseCompile, baseParse, createArrayExpression, createBlockExpression, createCacheExpression, createCallExpression, createCompilerError, createCompoundExpression, createConditionalExpression, createFunctionExpression, createInterpolation, createObjectExpression, createObjectProperty, createSequenceExpression, createSimpleExpression, createStructuralDirectiveTransform, findDir, findProp, generate, generateCodeFrame$1 as generateCodeFrame, getInnerRange, hasScopeRef, injectProp, isBuiltInType, isCoreComponent, isMemberExpression, isSimpleIdentifier, isSlotOutlet, isTemplateNode, isVSlot, loadDep, locStub, parseJS, registerRuntimeHelpers, toValidAssetId, transform, transformModel, transformOn, walkJS };
